...
class SpeechDisorderScenario(Scenario):
    ...
    options: List[str] = ["typically developing", "speech disorder", "unsure"]
    ...
    def get_instruction(self, words: str) -> str:
        return f"Listen to the audio and determine if the child speaker has a speech disorder or is typically developing. The speaker is trying to say {words}. If you are unsure, you can select 'unsure'. Only choose from the given options."
